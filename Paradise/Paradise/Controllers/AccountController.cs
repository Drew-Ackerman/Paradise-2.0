...
namespace Paradise.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        System.Collections.Generic.List<Paradise.Models.Admin> identity = new System.Collections.Generic.List<Paradise.Models.Admin>();
        ...
        public ActionResult CreateUser()
        {
            try
            {
                ...
                if (Request["isSuperAdmin"]?.ToUpper() == "YES" || Request["isSuperAdmin"]?.ToString() == "1")
                {
                    isSuperAdmin = true;
                }

                identity.Add(new Admin());
                identity[identity.Count - 1].userName = username;
                identity[identity.Count - 1].userPassword = password;
                identity[identity.Count - 1].superAdmin = isSuperAdmin;
                db.Admins.Add(identity[identity.Count - 1]);
            }
            catch (Exception)
            {
